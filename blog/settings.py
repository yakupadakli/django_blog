...
EMAIL_HOST_USER = 'yakupformail@gmail.com'
EMAIL_HOST_PASSWORD = '12345yakup'
EMAIL_PORT = 587
...
ADMINS = (
# ('yakupadakli', 'yakup.adakli@hotmail.com'),
)
...
DATABASES = {
    'default': {
        ...
        'NAME': '/home/yakupadakli/Documents/django-yakup/blog/blog.db', # Or path to database file if using sqlite3.
...
SECRET_KEY = 'htbpf*i)k6y%*g0+r5=4d*e^lw2$%vecj-4yb3_xgpz@dlc$!3'
...
TEMPLATE_DIRS = (
    ...
    os.path.join(PROJECT_DIR, 'article/templates'),
    os.path.join(PROJECT_DIR, 'account/templates'),
    os.path.join(PROJECT_DIR, 'comment/templates'),
)
...
DEBUG_TOOLBAR_CONFIG = {
    ...
    # 'EXTRA_SIGNALS': ['blog.signals.MySignal'],
